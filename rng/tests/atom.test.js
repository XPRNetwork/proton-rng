...
// console.log(fs.readFileSync(path.resolve(__dirname, 'private.pem')).toString('utf-8'))
// const privateKey = crypto.createPrivateKey({
//   key: fs.readFileSync(path.resolve(__dirname, 'private.pem')).toString('utf-8'),
//   format: 'pem',
//   type: 'pkcs1'
// })
// const publicKey = crypto.createPrivateKey({
//   key: fs.readFileSync(path.resolve(__dirname, 'public.pem').toString('utf-8')),
//   format: 'pem',
//   type: 'pkcs1'
// })
